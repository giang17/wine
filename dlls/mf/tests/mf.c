...
DEFINE_EXPECT(test_time_source_sink_OnClockStop);
...
static HRESULT WINAPI test_time_source_sink_OnClockStop(IMFClockStateSink *iface, MFTIME system_time)
{
    ...
    hr = (expect_test_time_source_sink_OnClockStop) ? S_OK : E_NOTIMPL;
    CHECK_EXPECT(test_time_source_sink_OnClockStop);
    return hr;
}
...
static struct test_state_time_source *impl_state_time_source_from_IMFPresentationTimeSource(IMFPresentationTimeSource *iface)
{
    return CONTAINING_RECORD(iface, struct test_state_time_source, IMFPresentationTimeSource_iface);
}

static struct test_state_time_source *impl_state_time_source_from_IMFClockStateSink(IMFClockStateSink *iface)
{
    return CONTAINING_RECORD(iface, struct test_state_time_source, IMFClockStateSink_iface);
}

static HRESULT WINAPI test_state_time_source_QueryInterface(IMFPresentationTimeSource *iface, REFIID riid, void **obj)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFPresentationTimeSource(iface);
...
static ULONG WINAPI test_state_time_source_AddRef(IMFPresentationTimeSource *iface)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFPresentationTimeSource(iface);
    return InterlockedIncrement(&source->refcount);
}

static ULONG WINAPI test_state_time_source_Release(IMFPresentationTimeSource *iface)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFPresentationTimeSource(iface);
    return InterlockedDecrement(&source->refcount);
}

static HRESULT WINAPI test_state_time_source_GetClockCharacteristics(IMFPresentationTimeSource *iface, DWORD *flags)
{
    *flags = MFCLOCK_CHARACTERISTICS_FLAG_FREQUENCY_10MHZ;
    return S_OK;
}

static HRESULT WINAPI test_state_time_source_GetCorrelatedTime(IMFPresentationTimeSource *iface, DWORD reserved,
        LONGLONG *clock_time, MFTIME *system_time)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFPresentationTimeSource(iface);
...
static HRESULT WINAPI test_state_time_source_GetContinuityKey(IMFPresentationTimeSource *iface, DWORD *key)
{
    *key = 0;
    return S_OK;
}

static HRESULT WINAPI test_state_time_source_GetState(IMFPresentationTimeSource *iface, DWORD reserved, MFCLOCK_STATE *state)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFPresentationTimeSource(iface);
    *state = source->state;
    return S_OK;
...
static HRESULT WINAPI test_state_time_source_GetProperties(IMFPresentationTimeSource *iface, MFCLOCK_PROPERTIES *props)
{
...
static HRESULT WINAPI test_state_time_source_GetUnderlyingClock(IMFPresentationTimeSource *iface, IMFClock **clock)
{
    *clock = NULL;
    return MF_E_NO_CLOCK;
}

static const IMFPresentationTimeSourceVtbl test_state_time_source_vtbl =
{
    test_state_time_source_QueryInterface,
    test_state_time_source_AddRef,
    test_state_time_source_Release,
    test_state_time_source_GetClockCharacteristics,
    test_state_time_source_GetCorrelatedTime,
    test_state_time_source_GetContinuityKey,
    test_state_time_source_GetState,
    test_state_time_source_GetProperties,
    test_state_time_source_GetUnderlyingClock,
};

static HRESULT WINAPI test_state_time_source_sink_QueryInterface(IMFClockStateSink *iface, REFIID riid, void **obj)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
    return IMFPresentationTimeSource_QueryInterface(&source->IMFPresentationTimeSource_iface, riid, obj);
}

static ULONG WINAPI test_state_time_source_sink_AddRef(IMFClockStateSink *iface)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
    return IMFPresentationTimeSource_AddRef(&source->IMFPresentationTimeSource_iface);
}

static ULONG WINAPI test_state_time_source_sink_Release(IMFClockStateSink *iface)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
    return IMFPresentationTimeSource_Release(&source->IMFPresentationTimeSource_iface);
}

static HRESULT WINAPI test_state_time_source_sink_OnClockStart(IMFClockStateSink *iface, MFTIME system_time, LONGLONG offset)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
...
static HRESULT WINAPI test_state_time_source_sink_OnClockStop(IMFClockStateSink *iface, MFTIME system_time)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
...
static HRESULT WINAPI test_state_time_source_sink_OnClockPause(IMFClockStateSink *iface, MFTIME system_time)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
    MFTIME systime;
...
static HRESULT WINAPI test_state_time_source_sink_OnClockRestart(IMFClockStateSink *iface, MFTIME system_time)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
...
static HRESULT WINAPI test_state_time_source_sink_OnClockSetRate(IMFClockStateSink *iface, MFTIME system_time, float rate)
{
    struct test_state_time_source *source = impl_state_time_source_from_IMFClockStateSink(iface);
...
static const IMFClockStateSinkVtbl test_state_time_source_sink_vtbl =
{
    test_state_time_source_sink_QueryInterface,
    test_state_time_source_sink_AddRef,
    test_state_time_source_sink_Release,
    test_state_time_source_sink_OnClockStart,
    test_state_time_source_sink_OnClockStop,
    test_state_time_source_sink_OnClockPause,
    test_state_time_source_sink_OnClockRestart,
    test_state_time_source_sink_OnClockSetRate,
};

static void init_test_state_time_source(struct test_state_time_source *source)
{
    memset(source, 0, sizeof(*source));
    source->IMFPresentationTimeSource_iface.lpVtbl = &test_state_time_source_vtbl;
    source->IMFClockStateSink_iface.lpVtbl = &test_state_time_source_sink_vtbl;
    source->refcount = 1;
    source->rate = 1.0f;
}
...
{
    struct test_state_time_source source1, source2, source3, source4;
    ...
    init_test_state_time_source(&source1);
    init_test_state_time_source(&source2);
    init_test_state_time_source(&source3);
    init_test_state_time_source(&source4);
...
static void test_presentation_clock(void)
{
    ...
    IMFClockStateSink test_sink = { &test_clock_sink_vtbl };
    struct test_seek_clock_sink *test_clock_sink;
    struct test_time_source *test_time_source;
    IMFPresentationTimeSource *time_source;
    ...
    /* After AddClockStateSink() adds an independent clock state sink, an initial OnClock*()
     * call occurs if the clock state has changed from its initial invalid state. */

    test_clock_sink = create_test_seek_clock_sink();

    /* Test invalid state. */
    memset(&actual_object_state_record, 0, sizeof(actual_object_state_record));
    hr = IMFPresentationClock_AddClockStateSink(clock, &test_clock_sink->IMFClockStateSink_iface);
    ok(hr == S_OK, "Failed to add a sink, hr %#lx.\n", hr);
    Sleep(50);
    ok(!actual_object_state_record.state_count, "got count %u\n", actual_object_state_record.state_count);
    IMFPresentationClock_RemoveClockStateSink(clock, &test_clock_sink->IMFClockStateSink_iface);

    SET_EXPECT(test_time_source_sink_OnClockStop);
    hr = IMFPresentationClock_Stop(clock);
    ok(hr == S_OK, "Unexpected hr %#lx.\n", hr);
    ...
    ok(hr == S_OK, "Failed to add a sink, hr %#lx.\n", hr);
    Sleep(50);
    ok(actual_object_state_record.state_count == 1 && actual_object_state_record.states[0] == SINK_ON_CLOCK_STOP,
            "got count %u, state %u\n", actual_object_state_record.state_count, actual_object_state_record.states[0]);
    IMFPresentationClock_RemoveClockStateSink(clock, &test_clock_sink->IMFClockStateSink_iface);

    IMFClockStateSink_Release(&test_clock_sink->IMFClockStateSink_iface);
