...
struct async_web_account_provider
{
    IAsyncOperation_WebAccountProvider IAsyncOperation_WebAccountProvider_iface;
    IAsyncInfoImpl *IAsyncInfoImpl_inner;
    LONG ref;
};

static inline struct async_web_account_provider *impl_from_IAsyncOperation_WebAccountProvider( IAsyncOperation_WebAccountProvider *iface )
{
    return CONTAINING_RECORD( iface, struct async_web_account_provider, IAsyncOperation_WebAccountProvider_iface );
}

static HRESULT WINAPI async_web_account_provider_QueryInterface( IAsyncOperation_WebAccountProvider *iface, REFIID iid, void **out )
{
    struct async_web_account_provider *impl = impl_from_IAsyncOperation_WebAccountProvider( iface );
    ...
    if (IsEqualGUID( iid, &IID_IUnknown ) ||
        IsEqualGUID( iid, &IID_IInspectable ) ||
        IsEqualGUID( iid, &IID_IAgileObject ) ||
        IsEqualGUID( iid, &IID_IAsyncOperation_WebAccountProvider ))
    {
        IInspectable_AddRef( (*out = &impl->IAsyncOperation_WebAccountProvider_iface) );
        return S_OK;
    }
...
static ULONG WINAPI async_web_account_provider_AddRef( IAsyncOperation_WebAccountProvider *iface )
{
    struct async_web_account_provider *impl = impl_from_IAsyncOperation_WebAccountProvider( iface );
    ULONG ref = InterlockedIncrement( &impl->ref );
    TRACE( "iface %p, ref %lu.\n", iface, ref );
...
static ULONG WINAPI async_web_account_provider_Release( IAsyncOperation_WebAccountProvider *iface )
{
    struct async_web_account_provider *impl = impl_from_IAsyncOperation_WebAccountProvider( iface );
    ULONG ref = InterlockedDecrement( &impl->ref );
    TRACE( "iface %p, ref %lu.\n", iface, ref );
...
static HRESULT WINAPI async_web_account_provider_GetIids( IAsyncOperation_WebAccountProvider *iface, ULONG *iid_count, IID **iids )
{
    FIXME( "iface %p, iid_count %p, iids %p stub!\n", iface, iid_count, iids );
    return E_NOTIMPL;
}

static HRESULT WINAPI async_web_account_provider_GetRuntimeClassName( IAsyncOperation_WebAccountProvider *iface, HSTRING *class_name )
{
    return WindowsCreateString( L"Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccountProvider>",
                                ARRAY_SIZE(L"Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccountProvider>"),
                                class_name );
}

static HRESULT WINAPI async_web_account_provider_GetTrustLevel( IAsyncOperation_WebAccountProvider *iface, TrustLevel *trust_level )
{
    FIXME( "iface %p, trust_level %p stub!\n", iface, trust_level );
    return E_NOTIMPL;
}

static HRESULT WINAPI async_web_account_provider_put_Completed( IAsyncOperation_WebAccountProvider *iface,
                                                                              IAsyncOperationCompletedHandler_WebAccountProvider *handler )
{
    struct async_web_account_provider *impl = impl_from_IAsyncOperation_WebAccountProvider( iface );
    TRACE( "iface %p, handler %p.\n", iface, handler );
...
static HRESULT WINAPI async_web_account_provider_get_Completed( IAsyncOperation_WebAccountProvider *iface,
                                                                              IAsyncOperationCompletedHandler_WebAccountProvider **handler )
{
    struct async_web_account_provider *impl = impl_from_IAsyncOperation_WebAccountProvider( iface );
    TRACE( "iface %p, handler %p.\n", iface, handler );
...
static HRESULT WINAPI async_web_account_provider_GetResults( IAsyncOperation_WebAccountProvider *iface, IWebAccountProvider **results )
{
    struct async_web_account_provider *impl = impl_from_IAsyncOperation_WebAccountProvider( iface );
    ...
    *results = NULL;
    ...
    {
        /* hand the reference obtained from get_Result over to the caller */
        *results = (IWebAccountProvider *)result.punkVal;
        result.punkVal = NULL;
    }
...
static const struct IAsyncOperation_WebAccountProviderVtbl async_web_account_provider_vtbl =
{
    /* IUnknown methods */
    async_web_account_provider_QueryInterface,
    async_web_account_provider_AddRef,
    async_web_account_provider_Release,
    /* IInspectable methods */
    async_web_account_provider_GetIids,
    async_web_account_provider_GetRuntimeClassName,
    async_web_account_provider_GetTrustLevel,
    /* IAsyncOperation<WebAccountProvider> */
    async_web_account_provider_put_Completed,
    async_web_account_provider_get_Completed,
    async_web_account_provider_GetResults,
};

HRESULT async_operation_web_account_provider_create( IUnknown *invoker, IUnknown *param, async_operation_callback callback,
                                                    IAsyncOperation_WebAccountProvider **out )
{
    struct async_web_account_provider *impl;
    HRESULT hr;

    *out = NULL;
    if (!(impl = calloc( 1, sizeof(*impl) ))) return E_OUTOFMEMORY;
    impl->IAsyncOperation_WebAccountProvider_iface.lpVtbl = &async_web_account_provider_vtbl;
    impl->ref = 1;

    if (FAILED(hr = async_info_create( invoker, param, callback, (IInspectable *)&impl->IAsyncOperation_WebAccountProvider_iface, &impl->IAsyncInfoImpl_inner )) ||
    ...
    *out = &impl->IAsyncOperation_WebAccountProvider_iface;
    TRACE( "created IAsyncOperation_WebAccountProvider %p\n", *out );
    return S_OK;
}
