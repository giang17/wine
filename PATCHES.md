...
| Minimal Hub | Tauri (Rust + WebView2) | Starts, runs and installs products. Its installer step shells out to `powershell Start-Process`, so it needs the `powershell` patch from this branch |
